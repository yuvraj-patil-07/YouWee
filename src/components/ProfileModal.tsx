            ...
            <div className="grid gap-4 sm:gap-6 lg:grid-cols-[280px_1fr]">
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                {currentUser ? (
                  ...
                  <div className="rounded-2xl sm:rounded-3xl border border-white/10 bg-black/40 p-4 sm:p-6 text-center">
                    <h4 className="text-lg font-black text-white mb-2">Create your YouWe Profile</h4>
                    <p className="text-xs sm:text-sm text-white/60 mb-6">Sign in to save your playlists, like songs, and join Jam Rooms.</p>
                    <button
                      onClick={handleSignIn}
                      disabled={isSaving}
                      className="w-full rounded-xl sm:rounded-2xl bg-white px-4 py-3 text-sm font-bold text-black transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 flex items-center justify-center gap-3"
                    >
